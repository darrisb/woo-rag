...
const fallbackConfig: SettingsUiConfig = {
  ...
  extensions: {
    manifestUrl: '/wp-content/plugins/myobserver-rag-for-woocommerce/assets/settings-ui-extensions/manifest.json',
    assetsBaseUrl: '/wp-content/plugins/myobserver-rag-for-woocommerce/assets/settings-ui-extensions/',
  },
